...
app.config['MAIL_USERNAME'] = os.getenv('MAIL_USERNAM')
...
@app.cli.command('db_create')   # This is a custom command
def db_create():
    db.create_all()
    print('Database created!')


@app.cli.command('db_drop')   # This is a custom command
def db_drop():
    db.drop_all()
    print('Database dropped!')


@app.cli.command('db_seed')   # This is a custom command
def db_seed():
...
def planets():
    ...
    #     planets.append({'name': planet.planet_name,
